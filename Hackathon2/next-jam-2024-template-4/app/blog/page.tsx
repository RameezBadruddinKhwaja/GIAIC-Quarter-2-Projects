...
const blogPosts = [
  {
    id: 1,
    category: "Surf Aviation",
    date: "Aug 09 2020",
    title: "Mauris at orci non vulputate diam tincidunt nec.",
    excerpt:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Velit facilisis quis auctor pretium ipsum, eu rutrum...",
    image:
      "https://images.pexels.com/photos/736716/pexels-photo-736716.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: 2,
    category: "Surf Aviation",
    ...
    excerpt:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Condimentum eu malesuada vitae ultrices in in neque...",
    image:
      "https://images.pexels.com/photos/169865/pexels-photo-169865.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: 3,
    category: "Surf Aviation",
...
// Example “recent posts” for the sidebar
const recentPosts = [
  {
    id: 1,
    title: "Mauris at orci non vulputate diam tincidunt nec",
  ...
  },
  {
    ...
    date: "Aug 09 2020",
    image:
      "https://images.pexels.com/photos/364054/pexels-photo-364054.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
  {
    id: 3,
...
// Example “sale products” for the sidebar
const saleProducts = [
  {
    id: 1,
    name: "Duis lectus",
...
// Example “offer products” for the sidebar
const offerProducts = [
  {
    id: 1,
    name: "Mauris vitae",
    ...
    <div className="w-full">
      ...
      <section className="bg-white py-6 border-b border-gray-200">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl font-bold mb-1">Blog Page</h1>
          <p className="text-gray-600">Home . Pages . Blog Page</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-8">
          ...
          <motion.div className="w-full md:w-2/3" {...fadeInUp}>
            {blogPosts.map((blog) => (
              <div
                key={blog.id}
                className="bg-white mb-8 rounded-lg shadow-md overflow-hidden"
              >
            ...
            <div className="flex justify-center mt-8">
              <ul className="flex space-x-2">
                ...
                <li>
                  <button className="px-3 py-1 bg-gray-100 text-gray-600 rounded hover:bg-pink-100">
                    2
                  </button>
                </li>
                <li>
