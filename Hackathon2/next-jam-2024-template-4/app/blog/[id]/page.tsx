...
const recentPosts = [
  {
    ...
    date: "Aug 09 2020",
    image:
      "https://images.pexels.com/photos/5807815/pexels-photo-5807815.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
  {
    id: 2,
    ...
    date: "Aug 09 2020",
    image:
      "https://images.pexels.com/photos/4245823/pexels-photo-4245823.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
  {
    id: 3,
    title: "Mollis quis in nulla eget",
    date: "Aug 09 2020",
    image:
      "https://images.pexels.com/photos/4245823/pexels-photo-4245823.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
...
const saleProducts = [
  {
    ...
    date: "Aug 08 2020",
    image:
      "https://images.pexels.com/photos/4042809/pexels-photo-4042809.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
  {
    id: 2,
    name: "Nato nam",
...
const offerProducts = [
  {
    ...
    date: "Aug 08 2020",
    image:
      "https://images.pexels.com/photos/298864/pexels-photo-298864.jpeg?auto=compress&cs=tinysrgb&w=200",
  },
  {
    id: 2,
    name: "Mattis vero flipp",
    price: 180.0,
    date: "Aug 08 2020",
    image:
      "https://images.pexels.com/photos/5807815/pexels-photo-5807815.jpeg?auto=compress&cs=tinysrgb&w=200",
    ...
    <div className="w-full">
      ...
      <section className="bg-white py-6 border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="text-sm mb-2 text-gray-500">
            Home &gt; Pages &gt;{" "}
            <span className="text-pink-600">Single Blog</span>
          </nav>
          <h1 className="text-3xl font-bold mb-1">Single Blog</h1>
          <p className="text-gray-600">Home . Pages . Single Blog</p>
        </div>
      </section>
      ...
      <section className="py-12 bg-[#F7F7F7]">
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-8">
          ...
          <motion.div className="w-full md:w-2/3" {...fadeInUp}>
            {/* Big header image */}
            <div className="relative h-64 mb-6">
              <Image
                src="https://images.pexels.com/photos/736716/pexels-photo-736716.jpeg?auto=compress&cs=tinysrgb&w=1200"
                alt="Blog Post"
                fill
            ...
            <p className="text-gray-600 mb-4">
              ...
              purus, cursus vulputate id lacinia at, volutpat.
            </p>
            <p className="text-gray-600 mb-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
              nunc, montes, lacus consectetur sapien, amet. Consequat arcu,
              morbi facilisi erat posuere malesuadaLorem ipsum dolor sit amet,
              consectetur adipiscing elit.
            </p>
            {/* Blockquote or highlighted text */}
            <blockquote className="border-l-4 border-pink-600 pl-4 italic text-gray-700 mb-4">
              “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Commodo
              dictum sapien amet, consequat hoamik risus”
            </blockquote>
            {/* Additional images (side by side or below each other) */}
            <div className="flex flex-col md:flex-row gap-4 mb-4">
              <div className="relative h-48 flex-1">
                <Image
                  src="https://images.pexels.com/photos/210677/pexels-photo-210677.jpeg?auto=compress&cs=tinysrgb&w=600"
                  alt="Blog secondary image 1"
                  fill
                  style={{ objectFit: "cover" }}
                />
              </div>
            ...
            <p className="text-gray-600 mb-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Velit
              dapibus est, nunc, montes, lacus consectetur integer viverra. Sit
              morbi etiam team quam dones. Velit in nature augue dine platea
              placerat. Gravida mus massa habitasse erat bibendum. Condimentum
              eu malesuada vitae ultrices in in neque, porta dignissim. Adipiscing
              purus, cursus vulputate id lacinia at, volutpat. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit. Velit dapibus est, nunc,
              montes, lacus consectetur integer viverra. Sit morbi etiam team
              quam dones.
            </p>

            {/* Related Products */}
            <div className="bg-[#F7F7F7] p-4 md:p-6 rounded-md shadow-sm mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {relatedPosts.map((rp) => (
                  ...
                  >
                    <div className="h-32 bg-[#F6F7FB] flex items-center justify-center">
                      <Image
                        src={rp.image}
                        alt={rp.name}
                        width={80}
                    ...
                    <div className="p-4">
                      <h4 className="text-md font-semibold text-pink-600 mb-2">
                        {rp.name}
                      </h4>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <div className="bg-gray-100 w-20 h-20 mr-4">
                    <Image
                      src="https://images.pexels.com/photos/5807815/pexels-photo-5807815.jpeg?auto=compress&cs=tinysrgb&w=200"
                      alt="Recent post 1"
                      width={80}
                      height={80}
                  ...
                  <div className="text-sm">
                    <h4 className="font-semibold text-gray-800 hover:text-pink-600 cursor-pointer mb-1">
                      Sapien ac
                    </h4>
                    <p className="text-xs text-gray-500">Jan 07 2020</p>
                    <p className="text-gray-600 text-xs">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. A
                      in vitae rutrum vulputate consectetur...
                    </p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="bg-gray-100 w-20 h-20 mr-4">
                    <Image
                      src="https://images.pexels.com/photos/169865/pexels-photo-169865.jpeg?auto=compress&cs=tinysrgb&w=800"
                      alt="Recent post 2"
                      width={80}
                      height={80}
                      className="object-cover"
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-xs text-gray-500">Aug 12 2020</p>
                    <p className="text-gray-600 text-xs">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. A
                      in vitae rutrum vulputate consectetur...
                    </p>
          ...
          >
            ...
            <div className="bg-white p-6 rounded shadow-md">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-pink-600 text-white px-4 py-2 rounded-r hover:bg-pink-700 transition">
                  Q
                </button>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                {recentPosts.map((rp) => (
                  <li key={rp.id} className="flex items-center">
                    ...
                    />
                    <div className="text-sm">
                      <h4 className="font-semibold text-gray-800 hover:text-pink-600 cursor-pointer">
                        {rp.title}
                      </h4>
                ...
                {saleProducts.map((sp) => (
                  <li key={sp.id} className="flex items-center">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-xs text-gray-500">{sp.date}</p>
                      <p className="text-gray-600 font-bold">${sp.price.toFixed(2)}</p>
                    </div>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white p-6 rounded shadow-md">
              ...
              <ul className="space-y-4">
                {offerProducts.map((op) => (
                  <li key={op.id} className="flex items-center">
                    <Image
                      src={op.image}
                      alt={op.name}
                      width={60}
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-gray-600 font-bold">${op.price.toFixed(2)}</p>
                    </div>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white p-6 rounded shadow-md">
              ...
              <div className="flex flex-wrap gap-2">
                {["General", "Ashanti", "Insas", "Blbassa", "Nulla"].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-sm bg-gray-100 rounded hover:bg-pink-100 hover:text-pink-600 cursor-pointer"
                  >
                    {tag}
                  </span>
                ))}
