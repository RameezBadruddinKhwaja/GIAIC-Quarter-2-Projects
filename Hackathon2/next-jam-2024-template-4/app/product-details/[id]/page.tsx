...
const product = {
  ...
  color: "Black",
  shortDesc:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tellus porttitor purus eu volutpat sit.",
  images: [
    "https://images.pexels.com/photos/179911/pexels-photo-179911.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    "https://images.pexels.com/photos/2170283/pexels-photo-2170283.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    "https://images.pexels.com/photos/158741/gshock-watch-sports-watch-stopwatch-158741.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  ],
  categories: ["Chairs", "Furniture"],
  tags: ["Modern", "Home", "Chair"],
};
...
const relatedProducts = [
  ...
  },
  {
    ...
    rating: 5,
    image:
      "https://images.pexels.com/photos/833487/pexels-photo-833487.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    id: 3,
    name: "Wala Dummy Fashion",
    price: 52.0,
    rating: 4,
    image:
      "https://images.pexels.com/photos/3283142/pexels-photo-3283142.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    id: 4,
    ...
    rating: 3,
    image:
      "https://images.pexels.com/photos/834964/pexels-photo-834964.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
];
...
export default function ProductDetailsPage() {
  // Tab state for "Description," "Additional Info," "Reviews," "Video"
  const [activeTab, setActiveTab] = useState("description");

  // Main image state (if user clicks a thumbnail)
    ...
    <div className="w-full">
      ...
      <section className="bg-white py-6 border-b border-gray-200">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl font-bold mb-1">Product Details</h1>
          <p className="text-gray-600">Home . Pages . Product Details</p>
        </div>
      </section>
      ...
      <section className="py-12 bg-[#F7F7F7]">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-8">
          {/* Left: Image Gallery */}
          <motion.div
            className="lg:w-1/2 flex flex-col md:flex-row gap-4"
          ...
          >
              ...
              {product.images.map((img, idx) => (
                <div
                  ...
                  className={`cursor-pointer border ${
                    img === mainImage ? "border-pink-600" : "border-transparent"
            ...
            {/* Main Image */}
            <div className="flex-1 flex items-center justify-center bg-white rounded shadow-md">
              <Image
                src={mainImage}
                alt={product.name}
                width={400}
          ...
          {/* Right: Product Info */}
          <motion.div
            className="lg:w-1/2 bg-white p-6 rounded shadow-md flex flex-col"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            ...
            <div className="flex items-center mb-2">
              <p className="text-2xl font-bold text-pink-600 mr-4">
            ...
            {/* Add to Cart Button */}
            <button className="bg-pink-600 text-white px-6 py-2 rounded hover:bg-pink-700 transition w-40 mb-4">
              Add to Cart
            </button>
            {/* Categories, Tags */}
      ...
      {/* Tabbed Content (Description, Additional Info, Reviews, Video) */}
          ...
          >
            {activeTab === "description" && (
              <div className="text-gray-600 space-y-4">
                <h3 className="text-lg font-bold mb-2">Varius tempor:</h3>
                <p>
                  Aliquam de upkeep vulputate integer sagittis. Faucibus dolor
                  arcu faucibus vel erat id et. Hendrerit habitasse amet Mattis,
                  mauris arcu sed et bibendum. Scelerisque in metus sit. Netus
                  et malesuada fringilla nibh, egestas gravida sapien eu tempor
                  viverra. Magna eget faucibus cras justo, tortor id donec
                  feugiat. Tempus imperdiet quam massa. A dui, nibh lobortis
                  justo et eu. Et in fringilla vulputate nunc. Etiam vestibu.
                </p>
                <h4 className="text-md font-semibold mb-2">More details</h4>
                <ul className="list-disc list-inside space-y-1">
                  <li>Aliquam de upkeep vulputate integer sagittis.</li>
                  <li>Faucibus dolor arcu faucibus vel erat id et.</li>
                  <li>Hendrerit habitasse amet Mattis, mauris arcu sed.</li>
                  <li>Netus et malesuada fringilla nibh.</li>
                  <li>Tempus imperdiet quam massa.</li>
                </ul>
              </div>
            )}
            {activeTab === "additional" && (
              <div className="text-gray-600">
                <p>
                  ...
                  adipiscing elit. Vivamus eget erat vitae elit rutrum laoreet.
                </p>
              </div>
            )}
            {activeTab === "reviews" && (
              <div className="text-gray-600">
                <p>Reviews Section: No reviews yet. Be the first to review!</p>
              </div>
            )}
            {activeTab === "video" && (
              <div className="text-gray-600">
                <p>Video Section: Insert product demo video here.</p>
              </div>
            )}
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {relatedProducts.map((rp) => (
              ...
              >
                <div className="h-40 flex items-center justify-center bg-[#F6F7FB] mb-4">
                  <Image
                    src={rp.image}
                    alt={rp.name}
                    width={150}
                ...
                <div className="flex justify-center text-yellow-400 mb-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <FaStar
                      key={star}
                      size={14}
                      className={star <= rp.rating ? "text-yellow-400" : "text-gray-300"}
                    />
                  ))}
                </div>
                <p className="text-gray-600 font-bold">${rp.price.toFixed(2)}</p>
              </div>
            ))}
          </motion.div>
        </div>
